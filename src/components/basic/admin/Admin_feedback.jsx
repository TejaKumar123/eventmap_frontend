...
const Admin_feedback = ({ feedback }) => {
	return (
		<div className="w-full h-auto mt-[10px] flex flex-row items-start justify-start gap-[20px] px-[10px] py-[10px] rounded-lg bg-[#281D63]" key={uuid()}>
